...
class DABNet(nn.Module):
    def __init__(self, classes=3, block_1=2, block_2=2):
        super().__init__()
...
def init_net(net, resume='', gpu_ids=[]):
    ...
    if resume != '':
        ...
        # for name, parameters in checkpoint['model'].items():
        #     print(name, ':', parameters.size())
        # state_dict = {k: v for k, v in checkpoint['model'].items() if k != 'classifier.0.conv.weight'}
